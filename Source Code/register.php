...
if(isset($_POST['submit'])) {
    ...
    if(mysqli_num_rows($check_result) > 0) {
        echo "<script>alert('Account already exists with this email. Please use a different email.');</script>";
        echo "<script>window.location='register.php';</script>";
        exit;
    }

    //Insert Statement Starts here
    $sql="INSERT INTO customer(cust_type, custname, email, mob_no, cpassword, status) VALUES('Customer', '$_POST[custname]', '$email', '$_POST[mob_no]', '$cpassword', 'Active')";
