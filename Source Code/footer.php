		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Bazar peth, <span>Gragoti.</span></li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:abc@gmail.com">info@GO-GROCER.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+91 8830893445</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Information</h3>
...
?>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© <?php echo date('Y'); ?> E-RASHAN. All rights reserved 
				<?php
...
<div id="modmycart" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer" id="idorderlayout">
        <a href="billingpanel.php" type="button"  id="btn_order" name="btn_order" class="btn btn-warning">Click Here to Order</a>
      </div>
    </div>
  </div>
</div>
...
function load_change_qty(purchid,qty,cost)
{
	...
	{
		purchid: purchid, qty: qty, btnqtysubmit: "btnqty"
	},
	function(data){
