...
if (isset($_POST['submit'])) {
	...
	if (isset($_GET['editid'])) {
		...
		$sql = "UPDATE product SET catid='$_POST[catid]',prodname='$prodname',price='$_POST[price]',discount='$_POST[discount]',unit='$_POST[unit]',stockstatus='$_POST[stockstatus]',prodspecif='$prodspec'";
		...
		$sql = "INSERT INTO product(catid,prodname ,price,discount,unit,stockstatus,prodspecif,images,status) VALUES('$_POST[catid]','$prodname','$_POST[price]','$_POST[discount]','$_POST[unit]','$_POST[stockstatus]','" . nl2br($prodspec) . "','$arrserialfile','Active')";
		$qsql = mysqli_query($con, $sql);
		echo mysqli_error($con);
		if (mysqli_affected_rows($con) == 1) {
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<textarea name="prodspecif" id="prodspecif" placeholder="Enter Product Specification" class="form-control" style="height: 200px;"><?php 
							if($rsedit['prodspecif'] != NULL)
							{
								echo str_replace("<br />", "", $rsedit['prodspecif']);
							}							
							?></textarea>
						</div>
					</div>
